    ...
    <div className="flex justify-between items-start w-full">
        <div className="flex flex-col justify-start items-start gap-5">
            <div className="flex items-center gap-5">
                <div className={`text-xl font-bold uppercase ${isDarkMode ? 'text-white' : 'text-zinc-800'}`}>{scent}</div>
            ...
            <div className={`flex items-center gap-5 ${isDarkMode ? 'text-white' : 'text-zinc-800'}`}>
        ...
        <div className={`${isDarkMode ? 'text-white' : 'text-zinc-800'}`}>
            <span className="text-lg font-medium line-through">£45 {' '}</span>
            <span className="text-3xl font-bold">40/2 months</span>
        </div>
    </div>
    <div className="flex flex-col justify-start items-start gap-5">
        <div className={`text-base font-normal ${isDarkMode ? 'text-white' : 'text-zinc-800'}`}>Smells like: <span className="font-bold">Dior Sauvage</span>, Don't Be Shy (Retail Price: $375)</div>
